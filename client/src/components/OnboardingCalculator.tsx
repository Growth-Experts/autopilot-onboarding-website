          ...
          <div style={{ backgroundColor: "#ffffff", borderRadius: "1rem", padding: "2rem", border: "1px solid #f3f4f6" }} className="shadow-sm space-y-10">
            ...
            <div>
              <div className="flex justify-between items-baseline mb-4">
                <label className="text-sm font-semibold uppercase tracking-wide" style={{ color: "#171717" }}>Hires per month</label>
            ...
            <div>
              <div className="flex justify-between items-baseline mb-4">
                <label className="text-sm font-semibold uppercase tracking-wide" style={{ color: "#171717" }}>Admin hours per hire</label>
          ...
          <div className="flex flex-col gap-5">
            ...
            <div style={{ backgroundColor: "#ED7A30", borderRadius: "1rem", padding: "1.5rem", color: "#ffffff" }}>
              <div className="text-2xl font-bold tracking-tight mb-2">
                Up to {formatCurrency(results.savedCost)}/year recoverable
              </div>
              <div className="text-sm font-light mb-4" style={{ color: "rgba(255,255,255,0.85)" }}>
                Based on a conservative 60% reduction in manual admin time — see how Autopilot compares to your current cost.*
              </div>
              <Link href="/pricing">
            ...
            <p className="text-xs leading-relaxed px-1" style={{ color: "#9ca3af" }}>
              * 60% admin time reduction reflects the lower bound reported by organisations using structured onboarding automation. Source: SHRM / Deloitte onboarding research.
            </p>
          </div>
        </div>
      </div>
