          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-4xl font-bold text-[#171717] leading-tight mb-8 tracking-tighter">
                Onboarding delays slow down reseller potential
              </h2>
              ...
              <div className="space-y-8">
                <div className="bg-red-50 p-6 rounded-xl border-l-4 border-red-500">
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    Reseller onboarding delays chill revenue and stall activation. Manual approvals and dispersed data slow everything down.
                  </p>
                </div>
                ...
                <div className="bg-green-50 p-6 rounded-xl border-l-4 border-green-500">
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    Autopilot brings everything into one workflow—partners get approved faster, and ready to sell first without back-and-forth, missing steps, or follow-up emails.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-4xl mx-auto mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-[#171717] mb-6 tracking-tighter">
              Use one connected system for every reseller onboarding
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            <div className="bg-white p-10 rounded-2xl shadow-sm border border-gray-200 text-left hover:shadow-md transition-all hover:-translate-y-1">
              ...
              <h3 className="text-2xl font-bold text-[#171717] mb-4">Guided Partner Journey</h3>
              <p className="text-gray-600 leading-relaxed text-lg">
                Manage partner agreements, product training steps, portal access, compliance requirements, pricing approvals, and go-live activation all in one streamlined place.
              </p>
            </div>
            ...
            <div className="bg-white p-10 rounded-2xl shadow-sm border border-gray-200 text-left hover:shadow-md transition-all hover:-translate-y-1">
              ...
              <p className="text-gray-600 leading-relaxed text-lg">
                Every team sees what they need to do, every requirement is tracked, and every partner gets a consistent, predictable path to becoming sales-ready.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-bold leading-tight text-white max-w-5xl mx-auto tracking-tighter mb-8">
              Faster, Paperless Reseller Onboarding
            </h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {[
              "Reseller approval times reduced from 10 days to one day, with some applications completed in just 10 minutes.",
              "Validation checks at the point of entry mean no more illegible handwriting or missing information.",
              "Validated data is automatically pushed to Syntech’s existing financial and CRM systems, eliminating manual re-keying."
            ].map((point, i) => (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-start">
            <div className="text-left">
              <h2 className="text-4xl md:text-6xl font-extrabold leading-[1.1] tracking-tighter">
                Make reseller onboarding the easiest part of your day.
              </h2>
            </div>
