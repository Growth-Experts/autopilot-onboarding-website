          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-4xl font-bold text-[#171717] leading-tight mb-8 tracking-tighter">
                Onboarding delays hurt vendor partnerships
              </h2>
              ...
              <div className="space-y-8">
                <div className="bg-red-50 p-6 rounded-xl border-l-4 border-red-500">
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    Procurement, legal, compliance, and finance all need different information and they rarely collect it in the same way.
                  </p>
                </div>
                ...
                <div className="bg-green-50 p-6 rounded-xl border-l-4 border-green-500">
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    Autopilot eliminates duplicated work and creates a unified vendor onboarding workflow everyone can trust.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-4xl mx-auto mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-[#171717] mb-6 tracking-tighter">
              Use one connected system for every vendor onboarding
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            <div className="bg-white p-10 rounded-2xl shadow-sm border border-gray-200 text-left hover:shadow-md transition-all hover:-translate-y-1">
              ...
              <h3 className="text-2xl font-bold text-[#171717] mb-4">Guided Vendor Journey</h3>
              <p className="text-gray-600 leading-relaxed text-lg">
                Centralize vendor capture, documentation, compliance reviews, contact uploads, and multi-team approvals—without email chains.
              </p>
            </div>
            ...
            <div className="bg-white p-10 rounded-2xl shadow-sm border border-gray-200 text-left hover:shadow-md transition-all hover:-translate-y-1">
              ...
              <p className="text-gray-600 leading-relaxed text-lg">
                Procurement, Finance, Legal, and Operations stay aligned without email chains or duplicated work, so vendors get approved faster and more consistently.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-start">
            <div className="text-left">
              <h2 className="text-4xl md:text-6xl font-extrabold leading-[1.1] tracking-tighter">
                Make vendor onboarding the easiest part of your day.
              </h2>
            </div>
